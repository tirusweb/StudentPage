                ...
                <table className=" table-auto w-full ">
                  <thead>
                    <tr className=" w-full h-10 text-center leading-10  bg-blue-500 text-white font-bold text-sm   grid grid-cols-11">
                      ...
                      <th className=" border border-gray-200 col-span-7">Tên biểu mẫu Đề xuất</th>
                      <th className=" border border-gray-200 col-span-2">Đơn giá (VNĐ)</th>
                      <th className=" border border-gray-200 col-span-1"></th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className=" h-8  grid grid-cols-11">
                      <td className="border border-gray-200 px-2 text-center col-span-1">1</td>
                      <td className="border border-gray-200 px-2 col-span-7 text-left "> Test</td>
                      <td className="border border-gray-200 px-2 col-span-2 text-right">0</td>
