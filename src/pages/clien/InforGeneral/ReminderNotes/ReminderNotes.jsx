        ...
        <div className=" lg:mx-14 xs:mx-0  my-4">
          <div className="bg-white rounded">
            ...
            {ApiInforStudent.map((infor) => (
              <div key={infor.id} className=" mx-4 mt-4 mb-4 border border-solid  border-gray-300 rounded">
                <div  className=" cursor-pointer flex ml-2 pt-2 ">
                  <h2 onClick={() => handleDetail(infor.id)} className="text-blue-500  font-bold lg:text-xl xs:text-lg hover:text-blue-300  ">
                    {infor.title}
                  </h2>
                ...
                <p onClick={() => handleDetail(infor.id)} className={` font-semibold text-right text-red-500 text-sm  mr-3 pb-2 cursor-pointer hover:text-blue-300 ${isDetail === infor.id ? " hidden" : " block"} `}>
                  Xem chi tiết
                </p>
                <p className={` ${isDetail === infor.id ? "block" : " hidden"} ml-2 pb-2 text-gray-400 font-normal text-xs  `}>
                  {infor.desc}
                </p>
              </div>
            ))}
