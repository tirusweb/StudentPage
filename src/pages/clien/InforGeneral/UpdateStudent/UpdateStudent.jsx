          ...
          <div className="bg-white pb-6 rounded">
            <div className="">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className=" bg-blue-500 text-white font-bold text-sm cursor-pointer px-4 py-2 rounded hover:bg-blue-400 mr-4 mt-2">Lưu</button>
                ...
                <div className="grid mt-3 grid-cols-2 px-4  gap-4">
                  ...
                  <div className="lg:col-span-1  xs:col-span-2  ">
                    <p className=" text-gray-400 text-sm font-semibold ">Tên</p>
                    <input
                      readOnly
