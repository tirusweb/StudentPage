          ...
          <div className="bg-white rounded pb-10">
            <div>
              ...
              <div className=" grid grid-cols-6 gap-4 mx-2 mt-4">
                ...
                <input className=" lg:col-span-2 xs:col-span-6 border border-gray-200 outline-blue-300 px-4   " type="text" placeholder="Mã môn học/ Tên môn học " />
                <button onClick={toggleShow} className="xs:col-span-6 lg:col-span-1 lg:col-end-7 bg-cyan-500 hover:bg-cyan-400 text-white rounded font-semibold lg:text-sm xs:text-xs "> Xem Kế hoạch </button>
              </div>
              <div className="border-t mt-4 border-gray-100 border-solid"></div>

              <p className={` ${isShow ? "block" : " hidden"} text-gray-400 font-semibold lg:text-sm xs:text-xs ml-2 mt-4`}>Không có dữ liệu để hiển thị</p>
            </div>
          </div>
        </div>
      </div>
