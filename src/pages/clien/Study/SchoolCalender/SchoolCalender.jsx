            ...
            <div className="">
              ...
              <div className=" grid grid-cols-3 mt-4 gap-4 mx-2">
                ...
                >
                  ...
                  <option value="Hết hạn">Khoa Dệt may và Thời trang HN</option>
                  <option value="Hết hạn">Khoa Kế toán Kiểm toán ND</option>
                  <option value="Hết hạn">Khoa Du lịch và Khách sạn ND</option>
                  <option value="Hết hạn">
                    Trung tâm giáo dục Quốc phòng - An ninh HN
                  </option>
                  <option value="Hết hạn">Khoa Điện - Tự động hóa HN</option>
                  <option value="Hết hạn">Khoa Dệt may và Thời trang ND</option>
                  <option value="Hết hạn">
              ...
              <div className=" border-t mt-4  border-gray-100 border-solid"></div>
                <p className=" mx-2 mt-2 text-gray-500 text-sm font-bold "> Không có dữ liệu hiển thị</p>
            </div>
          </div>
        </div>
      </div>
