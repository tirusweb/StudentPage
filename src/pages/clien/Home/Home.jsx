          ...
          <div className="">
            <div className="">
                    ...
                    {ApiInforStudent.map((student) => (
                      <div className="md:col-span-1 xs:col-span-2 lg:text-sm xs:ml-2 xs:text-xs">
                        <span className="block text-gray-400 ">
                          MSSV: <b className=" text-gray-500">{student.msv}</b>
                        </span>
                        <span className="block text-gray-400 ">
                          Họ tên:{" "}
                        ...
                        <span className="block text-gray-400 ">
                          Ngày sinh:{" "}
                          <b className="text-gray-500">{student.dayofbirth}</b>
                        </span>
                        <span className="block text-gray-400 ">
                          Nơi sinh:{" "}
              ...
              <div className=" grid grid-cols-8 gap-2 mt-2">
                <div className=" bg-white lg:col-span-1 xs:col-span-4 flex-col flex items-center justify-around shadow-lg h-[120px] py-2 cursor-pointer ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className=" bg-white flex-col lg:col-span-1 xs:col-span-4 flex items-center justify-around shadow-lg h-[120px] py-2 cursor-pointer ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                ...
                <div className=" bg-white flex-col flex lg:col-span-1 xs:col-span-4 items-center justify-around shadow-lg h-[120px] py-2 cursor-pointer ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                  ...
                  <p className=" text-gray-400 text-sm"> Lịch theo tiến độ </p>
                </div>
                <div className=" bg-white flex-col flex lg:col-span-1 xs:col-span-4 items-center justify-around shadow-lg h-[120px] py-2 cursor-pointer ">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className=" bg-white flex-col flex lg:col-span-1 xs:col-span-4 items-center justify-around shadow-lg h-[120px] py-2 cursor-pointer ">
                  ...
                  <p className=" text-gray-400 text-sm"> Phiếu thu tổng hợp </p>
                </div>
              </div>
